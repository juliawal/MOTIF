...
from arboreto_added.core import create_graph, SGBM_KWARGS, RF_KWARGS, EARLY_STOP_WINDOW_LENGTH
...
def grnboost2(expression_data,
    ...
    return diy(expression_data=expression_data, regressor_type='GBM', regressor_kwargs=SGBM_KWARGS,
               ...
               early_stop_window_length=early_stop_window_length, limit=limit, seed=seed, verbose=verbose, target_genes=target_genes)
